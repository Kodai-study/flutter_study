...
abstract class $BookDataCopyWith<$Res> {
  ...
  @useResult
  $Res call({String title, String publisher});
}
...
class _$BookDataImpl implements _BookData {
  _$BookDataImpl({this.title = "noName", this.publisher = "noPublisher"});
  ...
  @override
  String toString() {
    return 'BookData(title: $title, publisher: $publisher)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, title, publisher);
...
abstract class _BookData implements BookData {
  factory _BookData({final String title, final String publisher}) =
      _$BookDataImpl;
